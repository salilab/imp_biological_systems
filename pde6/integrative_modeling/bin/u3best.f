...
C-----------------------------------------------------------------------
      ...
      REAL*8     R(3,3),XC(3),YC(3),WC,A(3,3),B(3,3),E0,EPS,
     ...
     4            (E1,E(1)),(E2,E(2)),(E3,E(3))
      DATA SQRT3,TOL,EPS/1.73205080756888D+00, 1.0D-2, 1.0D-05/
...
51    E(I)=DSQRT(D)
      IER=0
      IF ((E2.LE.(E1*EPS)).OR.((E2-E3).LE.(E1*EPS)))IER=-1
      D=E3
      IF (SIGMA.GE.0.0)GO TO 52
      D=-D
52    RMS=E0-TWO*(D+E2+E1)
