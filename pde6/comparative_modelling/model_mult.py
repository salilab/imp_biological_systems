...
class MyModel(automodel):
    def special_restraints(self, aln):
        ...
        # secondary structure - chain B (need to add 859 (= chain A size) to original numbers)
        ...
        s1 = selection(a.residue_range('12:A', '183:A')).only_atom_types('CA') | selection(a.residue_range('225:A', '460:A')).only_atom_types('CA')
        s2 = selection(a.residue_range('10:B', '181:B')).only_atom_types('CA') | selection(a.residue_range('223:B', '458:B')).only_atom_types('CA')
        #s1 = selection(a.residue_range('12:A', '183:A')).only_atom_types('CA') | selection(a.residue_range('225:A', '481:A')).only_atom_types('CA') | selection(a.residue_range('508:A', '624:A')).only_atom_types('CA') | selection(a.residue_range('629:A', '830:A')).only_atom_types('CA')
        #s2 = selection(a.residue_range('10:B', '181:B')).only_atom_types('CA') | selection(a.residue_range('223:B', '479:B')).only_atom_types('CA') | selection(a.residue_range('508:B', '624:B')).only_atom_types('CA') | selection(a.residue_range('629:B', '830:B')).only_atom_types('CA')
...
env = environ()
a = MyModel(env, alnfile='pde6-multiple-templates.ali',
            knowns=('3ibj.pdb','3dba.pdb','3bjc.pdb','1tbf.pdb'), sequence='pde6',
