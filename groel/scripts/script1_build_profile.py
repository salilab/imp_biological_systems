...
sdb = sequence_db(env, seq_database_file='data/datasets/pdb_95.pir',
                  seq_database_format='PIR', chains_list='ALL',
                  minmax_db_seq_len=(30, 4000), clean_sequences=True)

#-- Read in the target sequence/alignment
aln = alignment(env, file='data/sequences/groel_ecoli.ali',
...
prf.build(sdb, matrix_offset=-450,
